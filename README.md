# Seleção e Agrupamento de Dados com Python
Projeto desenvolvido em Python com o objetivo de demonstrar técnicas de seleção, filtragem e agrupamento de dados utilizando a biblioteca Pandas.
